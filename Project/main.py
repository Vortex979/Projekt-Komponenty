...
class Calculator(object):
    ...
    def __init__(self):
        ...
        self.window = Tk()
        self.window.geometry("2000x800")  # Zablokowwać okno  "1360x600"
        ...
        self.checkbox = Checkbutton(text="Bright/Dark mode", font=("Helvetica", 16), variable=self.checkbox_value)  # ogarnąć czemu się nie zaznacza
        self.window_setup()
        mainloop()
    ...
    def window_setup(self):
        ...
        self.entry_box = Text(width=22, height=2, spacing1=10, font=("Helvetica", 60), state="disabled",
        ...
        self.button_delete = self.make_button("del", 2, 3, self.delete_button_click)
        self.button_clear = self.make_button("clear", 2, 4, self.clear_button_click)
        ...
        self.label1 = Label(text="Operations history: ", font=("Helvetica", 30), bg=self.background_colour,
                                       fg=self.font_colour)
        self.label1.grid(row=0, column=6, sticky=W)
        self.history_listbox = Listbox(width=30, height=10, bg=self.background_colour,
                                       fg=self.font_colour, font=("Helvetica", 30))
        self.history_listbox.grid(row=1, rowspan=5, column=6, columnspan=5, sticky=W)

        self.history_scroll = Scrollbar(orient=VERTICAL)
    ...
    def make_button(self, button_text, button_row, button_column, button_action):
        button = Button(width=7, height=1, bg="white", fg="black", text=button_text, font=("Helvetica", 34))
