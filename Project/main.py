...
class Calculator(object):
    ...
    def window_setup(self):
        ...
        self.entry_box = Text(width=20, height=3, spacing1=10, font=("Helvetica", 60), state="disabled")
        ...
        self.button_delete = self.make_button("del", 1, 4, self.delete_button_click)
    ...
    def make_button(button_text, button_row, button_column, button_action):
        button = Button(width=10, height=1, bg="white", fg="black", text=button_text, font=("Helvetica", 30))
    ...
    def equation_button_click(self):
        ...
        self.modify_entry_box(self.equation)
